...
/**
 * Servlet implementation class EditMovielanguageController
 */
public class EditMovielanguageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditMovielanguageController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MovielanguageBean bean=dao.selectData(movielanguageid);
		if(bean!=null)
		{
			request.setAttribute("bean",bean);
			request.getRequestDispatcher("editmovielanguage.jsp").forward(request, response);
		}
		else
		{
