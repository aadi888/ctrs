...
/**
 * Servlet implementation class ListMoviebranchController
 */
public class ListMoviebranchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListMoviebranchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list!=null)
		{
			...
			request.getRequestDispatcher("listmoviebranch.jsp").forward(request, response);
		}
		else
		{
