...
<table>
<tr>
<td rowspan="7"><img src="images/s3.jpg" height="250" width="200"><br><span><font color="silver" size="h2"><strong>MOVIE:  </strong></font></span><span><%=bean.getMoviename()%></span><br/><span><font color="silver" size="h2"><strong>DIRECTOR:  </strong></font></span><span><%=bean.getDirector()%></span><br/><span><font color="silver" size="h2"><strong>WRITER:  </strong></font></span><span><%=bean.getWriter()%></span><br/>
